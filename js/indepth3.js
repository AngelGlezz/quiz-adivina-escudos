				  ...
				  "preguntas": [
				    {
				      ...
				      "respuestas": [
				        {
				          "respuesta": "<img class='option' src='"+urlIndepth+"images/respuestas/Barca1.png'>",
				          "tipo": "true"
				        },
				        {
				          "respuesta": "<img class='option' src='"+urlIndepth+"images/respuestas/Barca2.png'>",
				          "tipo": "false"
				        }
				      ]
				    },
				    {
				      ...
				      "respuestas": [
				        {
				          "respuesta": "<img class='option' src='"+urlIndepth+"images/respuestas/Atlas2.png'>",
				          "tipo": "false"
				        },
				        {
				          "respuesta": "<img class='option' src='"+urlIndepth+"images/respuestas/Atlas1.png'>",
				          "tipo": "true"
				        }
				      ]
				    },
				    {
				      ...
				      "respuestas": [
				        {
				          "respuesta": "<img class='option' src='"+urlIndepth+"images/respuestas/Bayern1.png'>",
				          "tipo": "false"
				        },
				        {
				          "respuesta": "<img class='option' src='"+urlIndepth+"images/respuestas/Bayern2.png'>",
				          "tipo": "true"
				        }
				      ]
				    },
				    {
				      ...
				      "respuestas": [
				        {
				          "respuesta": "<img class='option' src='"+urlIndepth+"images/respuestas/Chivas2.png'>",
				          "tipo": "true"
				        },
				        {
				          "respuesta": "<img class='option' src='"+urlIndepth+"images/respuestas/Chivas1.png'>",
				          "tipo": "false"
				        }
				      ]
				    },
				    {
				      ...
				      "respuestas": [
				        {
				          "respuesta": "<img class='option' src='"+urlIndepth+"images/respuestas/Brasil2.png'>",
				          "tipo": "false"
				        },
				        {
				          "respuesta": "<img class='option' src='"+urlIndepth+"images/respuestas/Brasil1.png'>",
				          "tipo": "true"
				        }
				      ]
				    },
				    {
				      ...
				      "respuestas": [
				        {
				          "respuesta": "<img class='option' src='"+urlIndepth+"images/respuestas/Chelsea2.png'>",
				          "tipo": "true"
				        },
				        {
				          "respuesta": "<img class='option' src='"+urlIndepth+"images/respuestas/Chelsea1.png'>",
				          "tipo": "false"
				        }
				      ]
				    },
				    {
				      ...
				      "respuestas": [
				        {
				          "respuesta": "<img class='option' src='"+urlIndepth+"images/respuestas/Mexico2.png'>",
				          "tipo": "true"
				        },
				        {
				          "respuesta": "<img class='option' src='"+urlIndepth+"images/respuestas/Mexico1.png'>",
				          "tipo": "false"
				        }
				      ]
				    },
				    {
				      ...
				      "respuestas": [
				        {
				          "respuesta": "<img class='option' src='"+urlIndepth+"images/respuestas/Real1.png'>",
				          "tipo": "false"
				        },{
				          "respuesta": "<img class='option' src='"+urlIndepth+"images/respuestas/Real2.png'>",
				          "tipo": "true"
				        }
				      ]
				    },
				    {
				      ...
				      "respuestas": [
				        {
				          "respuesta": "<img class='option' src='"+urlIndepth+"images/respuestas/Tibu2.png'>",
				          "tipo": "true"
				        },
				        {
				          "respuesta": "<img class='option' src='"+urlIndepth+"images/respuestas/Tibu1.png'>",
				          "tipo": "false"
				        }
				      ]
				    },
				    {
				      ...
				      "respuestas": [
				        {
				          "respuesta": "<img class='option' src='"+urlIndepth+"images/respuestas/United2.png'>",
				          "tipo": "false"
				        },
				        {
				          "respuesta": "<img class='option' src='"+urlIndepth+"images/respuestas/United1.png'>",
				          "tipo": "true"
				        }
				      ]
				    }
